...
def get_viewer_paths_vault():
    ...
    try:
        ...
        # Custom characters (pseudo keys like custom_characters/<slug>/skins):
        # animations come from their own AJ inside fighter.zip; the scene config
        # falls back to the donor skeleton
