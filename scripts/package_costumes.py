...
Usage: python package_costumes.py <input_folder>
Example: python package_costumes.py PlFxNr-sm4sh-fox
"""
...
def main():
    """Main entry point."""
    if len(sys.argv) < 2:
        print("Usage: python package_costumes.py <input_folder>")
        print("Example: python package_costumes.py PlFxNr-sm4sh-fox")
        sys.exit(1)
