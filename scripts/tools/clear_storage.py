...
Usage:
    python scripts/tools/clear_storage.py                # Clear storage only
    python scripts/tools/clear_storage.py --clear-intake # Also clear intake folder
    python scripts/tools/clear_storage.py --clear-logs   # Also clear logs
    python scripts/tools/clear_storage.py --all          # Clear everything
"""
