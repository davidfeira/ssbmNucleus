...
Usage:
    python migrate_to_intake.py <source_directory>
    python migrate_to_intake.py --from-website  # Use website test imports
"""
...
def migrate_directory(source_dir: Path):
    ...
    logger.info("\nNext steps:")
    logger.info("  1. Run: python manage_storage.py")
...
def main():
    if len(sys.argv) < 2:
        logger.info("Usage:")
        logger.info("  python migrate_to_intake.py <source_directory>")
        logger.info("  python migrate_to_intake.py --from-website")
        logger.info("\nExamples:")
        logger.info("  python migrate_to_intake.py ~/Downloads/costume-pack")
        logger.info("  python migrate_to_intake.py --from-website  # Use test imports")
        sys.exit(1)
